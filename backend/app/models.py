...
class Booking(Base):
    ...
    property_slug: Mapped[str | None] = mapped_column(String(100), nullable=True)
    ...
    checkin_date: Mapped[str | None] = mapped_column(String(20), nullable=True)
    checkout_date: Mapped[str | None] = mapped_column(String(20), nullable=True)
